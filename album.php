...
<body>
    ...
    <div class="section">
        <div class="container">
            <h3>Data Album</h3>
            <div class="box">
                <button><p><a href="tambah-album.php"><img src="img/tambah.png"  width="30x" />Tambah Data</a></p></button>
                <form method="post" action="crud-album.php">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td align="center">
                              ...
                              <a href="hapus-album.php?idp=<?php echo $row['albumid'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')"><img src="img/ha.png"  width="30x" style="margin-left: 5px;"/></a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
