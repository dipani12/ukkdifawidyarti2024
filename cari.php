       ...
       <div class="box">
          <?php
		      if($_GET['search'] != '' || $_GET['kat'] != ''){
			     $where = "judulfoto LIKE '%".$_GET['search']."%' AND namaalbum LIKE '%".$_GET['kat']."%' ";
			  }
              $kats = $_GET["kat"];
            //   echo "SELECT * FROM foto1 WHERE namaalbum = '$kats'"; die();
              $foto = mysqli_query($koneksi, "SELECT * FROM foto1 WHERE $where");
            ...
            <div class="col-4">
                ...
                <p class="harga"><?php echo substr($p['namalengkap']) ?></p>
