...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <button><p><a href="tambah-image.php"><img src="img/tambah.png"  width="30x" />Tambah Data</a></p></button>
                <table border="1" cellspacing="1" class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $foto = mysqli_query($koneksi, "SELECT * FROM foto1 WHERE userid = '$user' ");
                        ...
                        <tr>
                           ...
                           <td align="center">
                              ...
                              <a href="proses-hapus.php?idp=<?php echo $row['fotoid'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')"><img src="img/ha.png"  width="30x" style="margin-left: 5px;"/></a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
